...
from atvPratica_chatbot_graph import RAGState, app
...
with st.sidebar:
    ...
    st.write("======= Controles Estáticos =======")
    st.write("Ajustar antes de criar o banco")
    chunk_size = st.slider("Tamanho do chunk:", 100, 600, 300, step=50)
    chunk_overlap = st.slider("Overlap entre chunks:", 0, 200, 60, step=10)
    st.write("======= Controles Dinâmicos =======")
