...
vectordb = Chroma.from_documents(
    ...
    collection_name="wikipedia_pt_user",
    persist_directory="./chroma_wiki_user",
)
vectordb.persist()

# Configurar retriever com k definido pelo usuário
k = int(input("\nQuantos documentos relevantes deseja recuperar (<=3 ex: 2)? "))
retriever_user = vectordb.as_retriever(search_kwargs={"k": k})

print("Banco vetorial criado e retriever configurado com sucesso!\n")
